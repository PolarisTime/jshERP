<template>
  <j-modal
    ...
    <template slot="footer">
      ...
      <!--发起多级审核-->
      <a-button v-if="workflowEnabled && !checkFlag" @click="handleWorkflow()" type="primary">提交流程</a-button>
    </template>
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="12" :md="12" :sm="24">
            <a-form-item :labelCol="{span:4}" :wrapperCol="{span:20}" label="项目名称">
              <a-select placeholder="请先选择客户名称" v-decorator="[ 'organId', validatorRules.organId ]"
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="物流方">
              <a-select placeholder="请选择物流方" v-model="selectedCarrierId" allowClear
                :dropdownMatchSelectWidth="false" showSearch optionFilterProp="children">
    ...
    methods: {
      ...
      editAfter() {
        ...
        if (this.action === 'add') {
          ...
          this.selectedCarrierId = undefined
          ...
          let params = { headerId: this.model.id }
